...
<tiles:insertTemplate template="/WEB-INF/views/base/layout/layout-default.jsp">
    <tiles:putAttribute name="title" value="修改晒单"/>
        ...
        <script>
            ...
            $(function() {
                ...
                $(document).on("click", "#btnSave", function () {
                    ...
                    $.ajax({
                        url: '/c/page/console/auth/order/updateShaidan',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            shaidanId:shaidanId,
            ...
            <div class="editor-container">
                ...
                <div class="editor-body">
                    ...
                    <div class="mission-merchant">
                        ...
                        <div class="col1">
                            <span style="display: inline;">
                                <label style="width: 100px; text-align: left">晒单ID:</label>
                                <input id="sdId" value="${shaidan.sdId}" type="text" style="width: 70%">
                            </span>
                        </div>
                        <div class="col1">
                            <span style="display: inline;">
                                <label style="width: 100px; text-align: left">标题:</label>
                                <input id="txtTitle" disabled value="${shaidan.sdTitle}" type="text" style="width: 70%">
                            </span>
                        </div>
                        <div class="col1">
                            <span style="display: inline;">
                                <label style="width: 100px; text-align: left;">内容:</label>
                                <textarea id="txtContent" style="width: 70%; height: 100px;">${shaidan.sdContent}</textarea>
                            </span>
                        </div>
                        <div class="col1">
                            <span style="display: inline;">
                                ...
                                <input type="hidden" value="${shaidan.sdPhotolist}" id="txtReleaseImg" obj="reImg" />
                                <ul class="muti_box" obj="reImg">
                                    <c:forEach items="${shaidan.photos}" var="pic">
