    ...
    <tiles:putAttribute name="scriptArea">
        <script>
            ...
            $(document).on("click","#delete",function () {
                ...
                $.ajax({
                    url     :       "/c/page/console/auth/allow/delete",
                    type    :       "POST",
                    dataType:       "JSON",
                    data    :       {sid:shopId},
            ...
            $(document).on("click","#add",function () {
                ...
                $.ajax({
                    url     :       "/c/page/console/auth/allow/add",
                    type    :       "POST",
                    dataType:       "JSON",
                    data    :       {sid:shopId,
                                     title:title
    ...
    <tiles:putAttribute name="mainArea">
        ...
        <div class="main-bd">
            ...
            <div style="width:100%; overflow:scroll;">
                <p><span style="color: blue;font-size:  20px">允许中奖的商品:</span></p>
                ...
                <button id="delete" class="btn btn-success add_submit_btn" style="height: 50px">设为不能中奖</button>
            ...
            <%--</div>--%>
                <%--数据表格--%>
            <%--<div style="width:100%;">--%>
                <p><span style="color: blue;font-size:  20px">不能中奖的商品:</span></p>
                ...
                <button id="add" class="btn btn-success add_submit_btn" style="height: 50px">设为可以中奖</button>
            </div>
