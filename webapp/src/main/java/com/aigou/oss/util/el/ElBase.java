...
public class ElBase {
     ...
     * @return
     */
    public static String  ftm10Time(Integer timestamp) {
        if (timestamp == null|| timestamp==0){
            return "";
        }
        Long timestampLong = (long)timestamp*1000L;
        return new SimpleDateFormat(ElBase.FMT_yyyy_MM_dd_HH_mm_ss).format(new Date(timestampLong));
    }
