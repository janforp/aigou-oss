...
public class JuheMessage {
    ...
    public static void getRequest2(){
        ...
        Map params = new HashMap();//请求参数
        params.put("mobile","13738053603");//接收短信的手机号码
        params.put("tpl_id","1");//短信模板ID，请参考个人中心短信模板设置
        params.put("tpl_value","#shop#="+"100园话费");//变量名和变量值对。如果你的变量名或者变量值中带有#&=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，<a href="http://www.juhe.cn/news/index/id/50" target="_blank">详细说明></a>
        params.put("key",APPKEY);//应用APPKEY(应用详细页查询)
    ...
    //可以传参数的发送短信
    public static String sendMsg (String shop,String phone,String msgTplID) throws UnsupportedEncodingException {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String msgBackStr = JuheMessage.sendMsg(" 朱晨剑正在测试 ","13456759092", ValueConsts.MSG_TPL_VIRTUAL_ID);
