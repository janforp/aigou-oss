package com.aigou.oss.config;

import com.aigou.oss.consts.BaseConsts;
import com.aigou.oss.util.PropertiesLoader;
import com.aigou.oss.util.support.WujieStringConverter;
...
public final class Config {
    ...
    static {
        initBeanUtils();
        try {
            String profileNameProperties = "application.properties";
