...
public class MybatisCodeGenerate extends BaseTest {
    // -custom
    private static String[] tableNames = new String[]{"ag_category"};
    // 程序会自动找到basePath
    ...
    public void codegenForOneTable(String oneTableName) throws Exception {
        ...
        String schema = "hdm16005539_db";
        String fileCharset = "utf-8";
        String modalPackage = "com.aigou.oss.model";
        String daoPackage = "com.aigou.oss.dao";
